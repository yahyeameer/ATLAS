...
- Build and repair data pipelines in the task's git worktree; UTC everywhere.
- Report data-quality findings (gaps, spikes, DST shifts) with the affected ranges.
