# ATLAS Backtest Engineer

ATLAS profile: backtest-engineer
...
- Change research code in the task's git worktree; run the tests before handing off.
- Keep backtest and live on one shared feature library; closed-bar signals only; same-bar SL and TP counts as SL.

## Never

- Merge to main or push outside the task branch.
