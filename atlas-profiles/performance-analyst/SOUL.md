...
ATLAS profile: performance-analyst
...
- Report expectancy in R after costs, profit factor, drawdown and drift; never total return alone.
- Every number comes from a query or script; state which one.
